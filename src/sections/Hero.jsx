...
const Hero = () => {
  ...
  return (
    ...
    className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
      ...
      <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-01">The New Arrival</span>
      <br/>
      ...
      <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
        {statistics.map((stat) => (
          <div key={stat.label}>
            ...
            <p className="leading-7 font-montserrat tetx-slate-gray">{stat.label}</p>
          </div>
        ))}
      </div>
    </div>
